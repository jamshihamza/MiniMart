# UI-SYS-006 --- Global Search

**Surface:** Back Office\
**Area:** System\
**Primary roles/personas:** Manager, Admin, Back Office\
**Offline behavior:** READ_WRITE_LOCAL

## Purpose

Search authorized masters/documents without cross-module private-table
access.
...
1.  Context/header: Store/Counter/Business Date when relevant, user,
    local/cloud state.
2.  Primary task region: Global Search.
