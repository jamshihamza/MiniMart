# UI-SYS-008 --- About / Version / Compatibility
...
Installed versions, Store Node compatibility and build information.
...
1.  Context/header: Store/Counter/Business Date when relevant, user,
    local/cloud state.
2.  Primary task region: About / Version / Compatibility.
