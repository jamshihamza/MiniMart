# UI-CTRY-002 --- Country Rule Draft / Validation
...
Stage and validate country configuration without inventing legal values.
...
1.  Context/header: Store/Counter/Business Date when relevant, user,
    local/cloud state.
2.  Primary task region: Country Rule Draft / Validation.
