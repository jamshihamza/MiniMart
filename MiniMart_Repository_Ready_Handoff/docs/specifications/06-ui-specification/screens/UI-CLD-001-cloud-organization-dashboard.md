# UI-CLD-001 --- Cloud Organization Dashboard

**Surface:** Cloud Web\
**Area:** Cloud\
**Primary roles/personas:** Management, Admin\
**Offline behavior:** CLOUD_REQUIRED

## Purpose

Cross-store health/sync/summary without running billing.
...
1.  Context/header: Store/Counter/Business Date when relevant, user,
    local/cloud state.
2.  Primary task region: Cloud Organization Dashboard.
