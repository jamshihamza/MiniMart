# UI-PUR-004 --- Goods Receipt Workspace

**Surface:** Back Office\
**Area:** Purchasing\
**Primary roles/personas:** Purchase, Storekeeper, Manager\
**Offline behavior:** READ_WRITE_LOCAL

## Purpose

Receive against PO or direct-GRN capability when allowed.
...
1.  Context/header: Store/Counter/Business Date when relevant, user,
    local/cloud state.
2.  Primary task region: Goods Receipt Workspace.
