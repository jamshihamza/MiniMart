# UI-RPT-004 --- Purchase / Supplier Report

**Surface:** Back Office\
**Area:** Reports\
**Primary roles/personas:** Manager, Purchase, Accounts\
**Offline behavior:** READ_WRITE_LOCAL

## Purpose

Purchasing/payables reporting.
...
1.  Context/header: Store/Counter/Business Date when relevant, user,
    local/cloud state.
2.  Primary task region: Purchase / Supplier Report.
