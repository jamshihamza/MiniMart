-- MiniMart Database Model v1.2 FROZEN
-- COMPLETE REFERENCE DDL: 79/79 logical tables. Adopted persistence authority.
...
identifier_type_code varchar(40) NOT NULL, identifier_value text NOT NULL,
normalized_identifier_value text NOT NULL, country_code varchar(2), status varchar(40) NOT NULL,
created_at timestamptz NOT NULL, updated_at timestamptz, version bigint NOT NULL DEFAULT 0,
...
currency_code varchar(3) NOT NULL, active_country_code varchar(2) NOT NULL,
default_language_code text NOT NULL,
receipt_display_name text, receipt_header_text text, receipt_footer_text text,
contact_phone text, contact_email text,
address_line1 text, address_line2 text, address_city text, address_region text,
address_postal_code text, address_country_code varchar(2), address_freeform text,
status varchar(40) NOT NULL,
created_at timestamptz NOT NULL, updated_at timestamptz, version bigint NOT NULL DEFAULT 0,
FOREIGN KEY (tenant_id, company_id) REFERENCES org.companies(tenant_id, company_id),
...
item_code text, name text NOT NULL, short_description text,
sellable boolean NOT NULL, purchasable boolean NOT NULL, stock_managed boolean NOT NULL,
fractional_quantity_allowed boolean NOT NULL, weighed boolean NOT NULL,
batch_tracked boolean NOT NULL, expiry_tracked boolean NOT NULL,
skeleton_status varchar(40) NOT NULL, notes text,
base_item_uom_id uuid, sales_item_uom_id uuid, purchase_item_uom_id uuid,
status varchar(40) NOT NULL, created_at timestamptz NOT NULL, updated_at timestamptz,
version bigint NOT NULL DEFAULT 0,
UNIQUE (tenant_id, item_id),
CHECK (
  skeleton_status <> 'COMPLETE' OR status <> 'ACTIVE'
  OR (
    base_item_uom_id IS NOT NULL
    AND sales_item_uom_id IS NOT NULL
    AND (NOT purchasable OR purchase_item_uom_id IS NOT NULL)
  )
)
);
...
uom_code text NOT NULL, conversion_factor numeric(24,8) NOT NULL CHECK(conversion_factor>0),
quantity_precision smallint NOT NULL CHECK(quantity_precision BETWEEN 0 AND 8),
status varchar(40) NOT NULL,
FOREIGN KEY (tenant_id, item_id) REFERENCES catalog.items(tenant_id, item_id),
UNIQUE (tenant_id, item_uom_id),
UNIQUE (tenant_id, item_id, item_uom_id),
UNIQUE (tenant_id, item_id, uom_code)
);
...
ADD CONSTRAINT fk_item_base_uom
FOREIGN KEY (tenant_id, item_id, base_item_uom_id)
REFERENCES catalog.item_uoms(tenant_id, item_id, item_uom_id)
DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE catalog.items
ADD CONSTRAINT fk_item_sales_uom
FOREIGN KEY (tenant_id, item_id, sales_item_uom_id)
REFERENCES catalog.item_uoms(tenant_id, item_id, item_uom_id)
DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE catalog.items
ADD CONSTRAINT fk_item_purchase_uom
FOREIGN KEY (tenant_id, item_id, purchase_item_uom_id)
REFERENCES catalog.item_uoms(tenant_id, item_id, item_uom_id)
DEFERRABLE INITIALLY DEFERRED;
...
price numeric(24,8) NOT NULL, currency_code varchar(3) NOT NULL,
reference_price numeric(24,8), reference_price_kind varchar(40),
tax_price_context_code varchar(40), change_reason text,
...
tenant_id uuid NOT NULL,
company_id uuid NOT NULL, supplier_code text, name text NOT NULL,
status varchar(40) NOT NULL,
payment_terms_code text, credit_terms_code text, credit_period_days integer,
country_code varchar(2), notes text,
created_at timestamptz NOT NULL,
updated_at timestamptz,
version bigint NOT NULL DEFAULT 0,
...
tenant_id uuid NOT NULL, supplier_id uuid NOT NULL,
identifier_type_code varchar(40) NOT NULL, identifier_value text NOT NULL,
normalized_identifier_value text NOT NULL, country_code varchar(2), status varchar(40) NOT NULL,
created_at timestamptz NOT NULL, updated_at timestamptz, version bigint NOT NULL DEFAULT 0,
...
tenant_id uuid NOT NULL, supplier_id uuid NOT NULL,
contact_name text NOT NULL, purpose_code text,
...
tenant_id uuid NOT NULL,
company_id uuid NOT NULL, store_id uuid NOT NULL, supplier_id uuid NOT NULL, document_no text, status varchar(40) NOT NULL, currency_code varchar(3) NOT NULL,
company_snapshot_json jsonb,
store_snapshot_json jsonb,
snapshot_schema_version varchar(20),
supplier_snapshot_json jsonb, business_date date NOT NULL, posted_at timestamptz,
created_at timestamptz NOT NULL,
updated_at timestamptz,
version bigint NOT NULL DEFAULT 0,
UNIQUE (tenant_id, purchase_order_id)
,
CHECK (company_snapshot_json IS NULL OR jsonb_typeof(company_snapshot_json)='object'),
CHECK (store_snapshot_json IS NULL OR jsonb_typeof(store_snapshot_json)='object'),
CHECK (supplier_snapshot_json IS NULL OR jsonb_typeof(supplier_snapshot_json)='object')
);
...
tenant_id uuid NOT NULL,
company_id uuid NOT NULL, store_id uuid NOT NULL, supplier_id uuid NOT NULL, purchase_order_id uuid,
document_no text, supplier_reference text, supplier_invoice_date date,
company_snapshot_json jsonb,
store_snapshot_json jsonb,
snapshot_schema_version varchar(20),
supplier_snapshot_json jsonb,
status varchar(40) NOT NULL, currency_code varchar(3) NOT NULL, business_date date NOT NULL,
posting_envelope_id uuid, posted_at timestamptz,
created_at timestamptz NOT NULL,
updated_at timestamptz,
version bigint NOT NULL DEFAULT 0,
...
store_snapshot_json jsonb,
snapshot_schema_version varchar(20),
supplier_snapshot_json jsonb, business_date date NOT NULL, posting_envelope_id uuid, posted_at timestamptz,
created_at timestamptz NOT NULL,
updated_at timestamptz,
version bigint NOT NULL DEFAULT 0,
...
CHECK (company_snapshot_json IS NULL OR jsonb_typeof(company_snapshot_json)='object'),
CHECK (store_snapshot_json IS NULL OR jsonb_typeof(store_snapshot_json)='object'),
CHECK (customer_snapshot_json IS NULL OR jsonb_typeof(customer_snapshot_json)='object')
);
...
customer_id uuid, original_sale_id uuid, document_no text, status varchar(40) NOT NULL,
reason_code text, return_note text, currency_code varchar(3) NOT NULL,
company_snapshot_json jsonb,
store_snapshot_json jsonb,
snapshot_schema_version varchar(20),
customer_snapshot_json jsonb,
...
reason_code text, return_note text, disposition_code varchar(40) NOT NULL,
refund_value numeric(24,8) NOT NULL, tax_reversal_amount numeric(24,8) NOT NULL DEFAULT 0,
...
ALTER TABLE payments.refund_executions
...
tenant_id uuid NOT NULL,
company_id uuid NOT NULL, customer_code text, name text NOT NULL,
customer_type_code varchar(40), status varchar(40) NOT NULL,
phone text, email text,
address_line1 text, address_line2 text, address_city text, address_region text,
address_postal_code text, address_country_code varchar(2), address_freeform text,
notes text, pii_updated_at timestamptz,
created_at timestamptz NOT NULL,
updated_at timestamptz,
version bigint NOT NULL DEFAULT 0,
...
status varchar(40) NOT NULL, currency_code varchar(3) NOT NULL,
credit_limit_mode varchar(40) NOT NULL, credit_limit numeric(24,8) NOT NULL DEFAULT 0 CHECK(credit_limit>=0),
terms_code text, due_date_basis_code text,
...
tenant_id uuid NOT NULL,
company_id uuid NOT NULL, store_id uuid NOT NULL, customer_id uuid NOT NULL, credit_account_id uuid NOT NULL,
document_no text, status varchar(40) NOT NULL, tender_method_code varchar(40) NOT NULL,
company_snapshot_json jsonb,
store_snapshot_json jsonb,
snapshot_schema_version varchar(20),
customer_snapshot_json jsonb,
amount numeric(24,8) NOT NULL, currency_code varchar(3) NOT NULL, business_date date NOT NULL,
posting_envelope_id uuid, posted_at timestamptz,
created_at timestamptz NOT NULL,
updated_at timestamptz,
version bigint NOT NULL DEFAULT 0,
...
tenant_id uuid NOT NULL,
company_id uuid NOT NULL, store_id uuid, supplier_id uuid NOT NULL, document_no text,
status varchar(40) NOT NULL, financial_account_id uuid,
...
-- v1.2 controlled amendment: tenant-safe cross-reference for supplier payment source account.
